          ...
          case FUNC_CREATE_TABLE:
               {
                    ...
                    ret = scanf("%s %s", csv_file, bin_file);
          ...
          case FUNC_SELECT_STAR:
               {
                    ...
                    while (true) {
                         ...
                         if (!file_read_data_reg(f, &reg)) {
                              ...
                              // 
                              //  - o campo `next_byte_offset` é 0 (arquivo não tem registros de dados),
                              //    logo, a posição atual deveria ser a posição imediatamente após o cabeçalho
                              //
